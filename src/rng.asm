...
rng_pokey_hook:
	...
	LDA !ram_rng_counter : ASL : STA $72
	LDA !ram_pokey_rng : DEC : ASL #2 : CLC : ADC $72 : TAY

	LDA tbl_pokey_speed+0, Y : STA $0D40, X
...
rng_agahnim_hook:
	LDA !ram_agahnim_rng : BEQ JML_to_RNG
...
rng_helmasaur_hook:
	LDA !ram_helmasaur_rng : BEQ JML_to_RNG
	DEC
	RTL
...
rng_ganon_warp_location:
	LDA !ram_ganon_warp_location_rng : BEQ JML_to_RNG
	DEC
	RTL
...
rng_ganon_warp:
	LDA !ram_ganon_warp_rng : BEQ JML_to_RNG
	DEC
	RTL
...
rng_eyegore:
	LDA !ram_eyegore_rng : BEQ JML_to_RNG
	DEC
	RTL
...
rng_arrghus:
	LDA.l !ram_arrghus_rng : BEQ JML_to_RNG
	PHX
	DEC
...
rng_turtles:
	LDA !ram_turtles_rng : BEQ JML_to_RNG
	DEC
	RTL
...
rng_lanmola_1:
	LDA !ram_lanmola_rng : BEQ JML_to_RNG
	DEC
	RTL
...
; Conveyor Belt
rng_conveyor_belt:
	LDA !ram_conveyor_rng : BEQ JML_to_RNG
	DEC
	RTL

; Vitreous
choose_vitty_eye:
	LDA !ram_vitreous_rng : BEQ JML_to_RNG
